...
Chapters 03–13 (types, expressions, declarations, constraints,
relationships, modules, semantics, interchange, grammar, errors, stdlib)
are being authored in ROADMAP §0.2 order.
