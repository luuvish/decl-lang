...
| `benchmarks/` | shared performance workloads with checked results ([README](benchmarks/README.md)); timings are not CI assertions | `decl-ts/scripts/session-bench.ts`, `decl-py/scripts/session_bench.py`, `decl-rs/examples/sbench.rs` |
